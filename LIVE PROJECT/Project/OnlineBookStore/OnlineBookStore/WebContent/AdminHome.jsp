  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
          <li class="active"><a href="AdminHome.jsp">Admin Home<span class="sr-only">(current)</span></a></li>
...
<div class="mySlider">
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="panel-heading">Welcome to Administrator Panel</div>
      <div class="panel-body">
            <marquee behavior="alternate">    
                <img src="img/online_book_store.png" class="img-rounded" alt="admin">
            </marquee>
          </div>
    </div>
