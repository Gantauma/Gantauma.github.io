...
<html lang="en">
<head>
  <title>Bawcom Customers Union</title>
  <meta charset="utf-8">
    ...
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
        ...
        <a class="navbar-brand" href="HomePage.jsp">Online Book Store</a>
                    ...
                    ResultSet rst=stmt.executeQuery("select * from OrderDetails where cus_id='"+customer_id+"' and item_status='Que'");
                    ...
                    ResultSet rs=st.executeQuery("select * from categories where i_name like '%"+x+"%' and cat_type='Action_and_Adventure'");
