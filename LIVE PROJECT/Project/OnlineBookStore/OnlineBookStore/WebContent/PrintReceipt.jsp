...
<%
    ...
    Statement st3=com.onlinebookstore.db.DB.getConnect().createStatement();
    ResultSet rs3=st3.executeQuery("select * from receipt where customer_id='"+customer_id+"'");
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
          <li><a href="HomePage.jsp">Customer Home<span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="PrintReceipt.jsp">Print Receipt</a></li>
                                        ...
                                          </tr>
                                            <tr> 
                                              <%
                                                ...
                                                <td><a href="Print.jsp?<%=rs3.getString(5)%>">Print</a></td>
