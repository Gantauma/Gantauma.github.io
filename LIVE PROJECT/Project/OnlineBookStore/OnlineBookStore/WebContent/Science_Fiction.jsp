...
<%
    ...
    ResultSet srs=srt.executeQuery("select * from categories where cat_type='Science Fiction'");
%>
    ...
    <div class="modal-content" >
      ...
      <div class="modal-body">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="st_id" name="cus_id" placeholder="Student ID" aria-describedby="basic-addon1" >
            <br>
        </div>
        <br>
        <div class="input-group">
            ...
            <input type="password" class="form-control" id="st_id" name="cus_pwd" placeholder="Student Password" aria-describedby="basic-addon1" >
            <br>
        </div>
        <br>
        <div class="input-group">
            ...
            <input type="password" class="form-control" id="st_id" name="re_cus_pwd" placeholder="Re Enter Student Password" aria-describedby="basic-addon1" >
            <br>
        </div>
          <br>
        <div class="input-group">
        ...
        <div class="input-group">
            ...
            <input type="text" class="form-control"  id="st_num" name="cus_number" placeholder="Student Mobile Number" aria-describedby="basic-addon1" >
            <br>
        </div>
          <br>
        <div class="input-group">
            ...
            <textarea class="form-control" name="cus_addrs"  id="st_add" placeholder="Student Address" aria-describedby="basic-addon1"></textarea>
            <br>
        </div>
          <br>
      ...
      <div class="modal-body">
          <form action="Login" name="login" method="post" onsubmit="return logFun()">
           <div class="input-group">
            ...
            <input type="text" class="form-control"  id="cus_id" name="cus_id" placeholder="Student ID" aria-describedby="basic-addon1" >
            <br>
        </div>
          <br>
        <div class="input-group">
            ...
            <input type="password" class="form-control" name="cus_pwd"  id="st_pwd" placeholder="Student Password" aria-describedby="basic-addon1">
            <br>
        </div>
          <br>
