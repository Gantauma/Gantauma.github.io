...
public class Remove extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
           ...
           PreparedStatement pt=com.onlinebookstore.db.DB.getConnect().prepareStatement("update categories set i_quantity='"+add+"' where i_name='"+i_name+"'");
           pt.executeUpdate();
           PreparedStatement pst=com.onlinebookstore.db.DB.getConnect().prepareStatement("delete from OrderDetails where timeanddate='"+rmv+"' and cus_id='"+customer_id+"'");
           pst.executeUpdate();
