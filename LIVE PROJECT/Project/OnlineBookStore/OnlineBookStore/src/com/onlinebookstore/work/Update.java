...
public class Update extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try
            {
                ...
                PreparedStatement pst=com.onlinebookstore.db.DB.getConnect().prepareStatement("update categories set cat_type='"+i_ty+"',i_price='"+i_pr+"',i_quantity='"+l+"' where i_name='"+i_n+"'");
                pst.executeUpdate();
