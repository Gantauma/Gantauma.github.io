...
public class Ready extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            PreparedStatement pst=com.onlinebookstore.db.DB.getConnect().prepareStatement("update orderhistory set status='Ready',confirmtime='"+d.toString()+"' where cus_id='"+id+"' and timeanddate='"+dt+"' and i_name='"+item+"' ");
            pst.executeUpdate();
